...
const AuthorAvatar = tw.div`mr-5 mb-5 overflow-hidden relative`;
...
const AuthorHeader = tw.div`flex flex-row flex-nowrap`;
...
export default function ArticleFooterAuthor({
  ...
  let authorTitle = author.author_translations[0].title;
  let authorBio = author.author_translations[0].bio;
  return (
    <AuthorWrapper last={last}>
      <AuthorMeta meta={metadata}>
        ...
        <div className="dek" dangerouslySetInnerHTML={{ __html: authorBio }} />
      </AuthorMeta>
      <style jsx global>{`
        .dek p {
