...
const FounderSocialLinkWrapper = tw.ul`inline-flex flex-row flex-nowrap items-center`;
const FounderSocialLink = tw.li`mr-2`;
    ...
    <Footer>
      <div>
        ...
        <FounderSocialLinkWrapper>
          ...
          {founderTwitter && (
            <FounderSocialLink>
              <a href={founderTwitter} target="_blank" rel="noreferrer">
                <SocialIcon
                  style={{
                    backgroundImage:
