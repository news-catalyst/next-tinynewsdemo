...
import { hasuraGetSourceDistroBySexualOrientation } from '../../../lib/analytics';

const SubHeaderContainer = tw.div`pt-10 pb-5`;
const SubHeader = tw.h1`inline-block text-xl font-extrabold text-gray-900 tracking-tight`;

const SourcesBySexualOrientation = (props) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      window.location.hash === '#sexual_orientation'
    ) {
      if (sourceRef) {
...
SourcesBySexualOrientation.displayName = 'SourcesBySexualOrientation';
export default SourcesBySexualOrientation;
