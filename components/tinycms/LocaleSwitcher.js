...
export default function LocaleSwitcher({ currentLocale, locales, id }) {
  ...
  return (
    <div tw="relative inline-flex">
      <svg
        tw="w-2 h-2 absolute top-0 right-0 m-4 pointer-events-none"
      ...
      <select
        tw="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none"
        value={currentLocale}
