...
export const hasuraLocaliseText = (translations, fieldName) => {
  ...
  console.log('FieldName:', fieldName, 'translations:', translations);
...
export const renderAuthors = (article) => {
  ...
  const authors = article.author_articles.map(renderAuthor);
