...
export async function getArticleBySlug(slug, apiUrl) {
  ...
  console.log(GET_ARTICLE_BY_SLUG);
  console.log(slug);
...
export async function getHomepageArticles(hpData) {
    ...
    Object.entries(hpArticleData).map(([key, values]) => {
      if (typeof values === 'string') {
        ...
        (async () => {
          ...
          console.log('found single article:', foundArticle);
        ...
        (async () => {
          ...
          console.log('found multiple articles:', foundArticles);
  ...
  console.log('value of hpArticles:', hpArticles);
  return hpArticles;
}
...
export async function getAuthorBySlug(slug, apiUrl) {
  ...
  return authorData.authors.listAuthors.data;
}
