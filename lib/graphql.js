...
export async function fetchGraphQL(params) {
  ...
  //CHELSEA TODO: remove this when done
  // console.log(
  //   `*** Request info: URL - ${url} Headers - ${JSON.stringify(
  //     requestHeaders
  ...
  // CHELSEA TODO: remove this when done
  // const size = new TextEncoder().encode(JSON.stringify(resultingJson)).length;
  // const kbs = size / 1024;
  // console.log(`**** Result returned by ${operationName} is ${kbs} kb`);
