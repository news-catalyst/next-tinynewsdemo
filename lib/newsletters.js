...
export const HASURA_GET_NEWSLETTERS_FOR_SLUG = `query FrontendGetNewsletter($slug: String!, $locale_code: String!) {
...
export function hasuraGetNewslettersForSlug(params) {
  return fetchGraphQL({
    url: params['url'],
    site: params['site'],
    query: HASURA_GET_NEWSLETTERS_FOR_SLUG,
...
// TODO: This function is no longer used. Remove once newsletter fix is confirmed on production.
