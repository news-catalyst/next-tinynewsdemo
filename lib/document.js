  ...
  for (const element of elements) {
    if (element.paragraph && element.paragraph.elements) {
      ...
      if (subElements.length === 1) {
        ...
        let embeddableUrlRegex = /twitter\.com|youtube\.com|youtu\.be|instagram\.com|facebook\.com|spotify\.com|vimeo\.com|apple\.com|tiktok\.com|forms\.gle|docs\.google\.com\/forms/i;
        if (foundLink) {
