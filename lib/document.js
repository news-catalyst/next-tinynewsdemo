        ...
        if (eleData.type !== 'list' && eleData.type !== 'embed') {
          ...
          if (
            ...
            if (fullImageData) {
              ...
              // );
              // console.log(
              //   'imageID/fullImageData',
              //   imageID,
              //   JSON.stringify(fullImageData)
              // );
              // console.log('s3Url:', typeof s3Url, s3Url);
              ...
              if (
                ...
                uploadImageToS3(
                  ...
                  s3Url = s3Data.url;
                  console.log('s3 data:', s3Data, imageList[imageID]);
